...
const loadProfile = `${__ENV.LOAD_PROFILE}`
  ? profiles[`${__ENV.LOAD_PROFILE}`]
  : profiles.normal;
...
export default function () {
  ...
  switch (host) {
    case "frontend":
      url = "https://kea-foot-shop.onrender.com/";
      break;
    default:
      url = "https://kea-foot-shop-api.onrender.com/api/products";
  }
  http.get(url);
  sleep(1);
}
